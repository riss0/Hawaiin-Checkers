 ...
 * myType is 'h' for human, 'r' for random, and 'a' for minimax
 * myPiece is 'B' or 'W' for the player's game piece
 ...
 * If the player type is 'a' (minimax), a minimax optimal move is selected.
 ...
 */
bool Player::nextMove(Board& theBoard,  bool shouldPrintMove) {
	bool gameOver;
	bool illegalMove;
	int numMoves;
	int width = theBoard.getRows();
	...
	if (myType == 'r') {
		...
		cout << numMoves << " legal moves for " << myPiece << endl; 
